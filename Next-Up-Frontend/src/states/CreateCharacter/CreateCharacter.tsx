...
function CreateCharacter() {
  ...
  */
	...
	const [keyAbilityScoreSelected, setKeyAbilityScoreSelected] =
		useState<string>('');
  ...
  */
	...
	const [componentArrayPosition, setComponentArrayPosition] =
		useState<number>(0);
  ...
  */
	...
	const componentArray: JSX.Element[] = [
		...
		<CreateCharacterOptions optionType='Class' />,
		<CreateCharacterOptions optionType='Theme' />,
